...
<!--Body para la 4 pagina del sitio web "Clientes Satisfechos" -->
<body>
    ...
    <!--Unica seccion de la pagina Clientes Satisfechos-->
    <section class="reviews">
        <!--Contenedor generico el cual agrupa las diferentes reseñas hechas por los clientes-->
        <div class="reviews-content">
            <h2>Reseñas</h2>
            <!--Etiqueta div la cual contine una etiqueta span para alinear el simbolo de estrellas y el nombre del cliente-->
            <div class="review">
                <p class="stars">⭐⭐⭐⭐⭐ <span>María González</span></p>
                <p>😊 "Excelente servicio. Mi lavadora dejó de funcionar de repente, llamé y en menos de una hora ya tenían el diagnóstico. La repararon el mismo día y quedó como nueva. ¡Muy recomendados!"</p>
            </div>

            <!--Mas reseñas de clientes las cuales cumplen las mismas propiedades de las anteriores-->
            <div class="review">
                <p class="stars">⭐⭐⭐⭐⭐ <span>Laura Fernández</span></p>
                <p>😊 "Muy puntuales y eficientes. Se nota que saben lo que hacen. Mi lavadora hacía un ruido extraño y no centrifugaba bien, pero después de la reparación funciona perfecto. ¡Muchas gracias!"</p>
            </div>

            <div class="review">
                <p class="stars">⭐⭐⭐⭐⭐ <span>Carlos Ramírez</span></p>
                <p>😊 "Pensé que tenía que comprar una lavadora nueva, pero gracias a su equipo pude ahorrar dinero. El técnico fue muy profesional y me explicó todo el proceso. ¡Servicio de primera!"</p>
            </div>

            <div class="review">
                <p class="stars">⭐⭐⭐⭐⭐ <span>Javier Pérez</span></p>
                <p>😊 "Honestos y confiables. Me dieron un presupuesto claro desde el inicio y no hubo sorpresas. Además, me dieron garantía por el servicio. 100% recomendados."</p>
            </div>

            <div class="review">
                <p class="stars">⭐⭐⭐⭐⭐ <span>Ana Torres</span></p>
                <p>😊 "Fácil de contactar y rápidos en la respuesta. Me gustó que explicaran cada paso del proceso y no intentaron venderme piezas innecesarias. ¡Servicio excelente!"</p>
            </div>
        </div>
    </section>
